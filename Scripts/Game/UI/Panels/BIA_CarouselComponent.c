...
class BIA_CarouselComponent : ScriptedWidgetComponent
{
	...
	protected static ref array<BIA_CarouselComponent> s_aInstances;

	//------------------------------------------------------------------------------------------------
	protected static void EnsureInstances()
	{
		if (!s_aInstances)
			s_aInstances = new array<BIA_CarouselComponent>();
	}
	...
	{
		EnsureInstances();
		foreach (BIA_CarouselComponent instance : s_aInstances)
		{
