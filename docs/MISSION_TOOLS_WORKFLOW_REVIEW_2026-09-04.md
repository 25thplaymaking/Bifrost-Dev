...
| Scale Object | ZEN reads the attached object's current scale and provides a slider. | Superseded by the runtime-scale follow-up: accepts replicated GM-editable entities, including characters, vehicles and attached parts, at 0.01–100. Player entries resolve to controlled characters; selected physical descendants follow their selected parent. Native readback and replicated post-frame retention are implemented. Animation, collision, dedicated-server and remote/JIP behavior still require runtime acceptance; see RUNTIME_SCALE_2026-09-04.md and FEATURE_FUNCTIONAL_REVIEW_2026-09-04.md. |
